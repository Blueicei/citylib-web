...
(function(){
    ...
    Cluster.prototype.render = function(){
        var len = this._markers.length;
        this._name = this._markers[0].name + '_' + len
        this._points = []
        for (var i = 0; i < len; i++) {
            this._points.push(this._markers[i].name);
        }
    ...
    Cluster.prototype.updateClusterMarker = function () {
        ...
        // this._clusterMarker.setText(this._name);

        var thatMap = this._map;
        var thatBounds = this.getBounds();
        var thatCenter = this.getCenter();
        var name = this._name
        var len = this._markers.length
        var points = this._points
        this._clusterMarker.addEventListener("click", function(event){
            console.log('cluster_name:'+name+', cluster_center:[' + thatCenter.lng + ',' + thatCenter.lat + ']')
            this._map.currentCluster = {name:name,lng:thatCenter.lng, lat:thatCenter.lat,camNumber:len, points:points}
