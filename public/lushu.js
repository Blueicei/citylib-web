        ...
        */
        ...
        _setInfoWin: function(pos) {
            ...
            if (index !== -1) {
                ...
                me._overlay.setPosition(pos, me._marker.getIcon().size);
                // 输入的暂停点信息
                const pausePoi = me._opts.landmarkPois[index]
                const marker = new BMap.Marker(pausePoi);
                const label = new BMap.Label(pausePoi.info, {offset: new BMap.Size(20, 0)});
